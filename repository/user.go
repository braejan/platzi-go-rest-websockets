...
type UserRepository interface {
	...
	GetUserByID(ctx context.Context, userID int64) (user *entities.User, err error)
	DeleteUserByID(ctx context.Context, userID int64) (err error)
...
func GetUserByID(ctx context.Context, userID int64) (user *entities.User, err error) {
	err = errorEmptyRepository()
	if err != nil {
		return
	}
...
func DeleteUserByID(ctx context.Context, userID int64) (err error) {
	err = errorEmptyRepository()
	if err != nil {
		return
	}
